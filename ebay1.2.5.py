...
def webhook(sku, title, img, qty, status):
	...
	embed.add_field(name='Stock:', value=str(qty), inline=True)
...
def monitor(sku):
    try:
        ...
        src = soup.find("img", id="icImg")['src']

        """qty = soup.find("span", class_="qtyTxt").text.split()
        qty = ' '.join(qty).split(' / ')[0]"""

        qty = soup.find("div", id="shQuantity-errTxt").text.split()[2]
...
if __name__ == '__main__':
	...
	#303579326612 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F303579326612',
	...
	353099774129 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F353099774129',
	#233617635669 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F233617635669',
	...
	#353088044857 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F353088044857',
	#353115816304 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F353115816304',
	#233600586186 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F233600586186',
	233594266248 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F233594266248',
	353101506951 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F353101506951'
	#233630967100 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F233630967100',
	#353084083127 : 'http://rover.ebay.com/rover/1/711-53200-19255-0/1?ff3=4&pub=5575598825&toolid=10001&campid=5338702441&customid=pool&mpre=https%3A%2F%2Fwww.ebay.com%2Fitm%2F353084083127'
	}
...
╚══════╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝ ╚══▀▀═╝  ╚═════╝ ╚══════╝ 
                                                       """)
	print("*** eBay Monitor v.1.2.5 ***\n")
	loop = input("Press any key to start...")

	print('{} Products Loaded'.format(len(raw_ids)))
